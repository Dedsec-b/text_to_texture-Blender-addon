...
class AITextureProperties(PropertyGroup):
    ...
    backend_url: StringProperty(
        name="Backend URL",
        description="Your Kaggle ngrok URL (e.g., http://abc123.ngrok.io)",
        default="",
        maxlen=1024
    )
...
class AITEX_PT_MainPanel(Panel):
    ...
    def draw(self, context):
        ...
        box.label(text="1. Run Kaggle notebook")
        box.label(text="2. Copy ngrok URL")
        box.label(text="3. Paste URL above")
